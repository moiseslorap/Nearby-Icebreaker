...
//  Nearby-Icebreaker
//
//  Created by Tobias Genao on 6/16/21.
//
...
internal class NearViewModel: NSObject, ObservableObject
{
...
extension NearViewModel: NISessionDelegate
{
    /// La sesión no vale.
...
extension NearViewModel: MCSessionDelegate
{
...
extension NearViewModel: MCNearbyServiceAdvertiserDelegate
{
    ///
...
extension NearViewModel: MCNearbyServiceBrowserDelegate
{
    ///
